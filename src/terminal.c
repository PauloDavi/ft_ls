...
/*   Updated: 2025/04/07 23:22:24 by cobli            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t calculate_columns(size_t size, size_t term_width, size_t *col_widths, t_list **array);
...
void print_columns(t_list *list, const t_flags *flags) {
  ...
  size_t cols = calculate_columns(size, term_width, col_widths, array);
